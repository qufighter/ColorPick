...
var panelFloating = require("sdk/panel-floating");
...
pageMod.PageMod({
  ...
  contentScriptFile: [data.url('installkey.user.js')],
...
function createPopupByEnum(popup_enum){
	var panelOpts=false;
	if(popup_enum=='POPUP_PREVIEW'){
		...
		panelOpts={
		  ...
		  contentScriptFile: [data.url('chrome-api.js'),data.url('Cr_min.js'),data.url('license.js'),data.url('license-ff-extra.js')],
		  contentScriptWhen: "end",
		};
		...
		panelOpts={
		  ...
		  contentURL: data.url("register-ff.html"),
