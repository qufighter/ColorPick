...
function setDisplay(){//Cr.elm
	...
	Cr.elm('div',{},[
		...
		Cr.elm('a',{href: 'https://vidsbee.com/ColorPick/Thanks/?search=%23'+hex+' '+fmt_rgb, childNodes:[Cr.elm('img', {style:iconStyles,src: chrome.extension.getURL('img/icons/search.png')})]}),
