...
pOptions["disableRewriting"]={def:false,ind:0}; //this option has no effect, but is required so that old reviews make logical sense, if people want to opt out of something that doesn't exist they can
